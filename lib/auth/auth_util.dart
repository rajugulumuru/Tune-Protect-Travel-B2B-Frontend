...
DocumentReference? get currentUserReference => currentUser?.user != null
    ? AgencyUsersRecord.collection.doc(currentUser!.user!.uid)
    : null;

AgencyUsersRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : AgencyUsersRecord.getDocument(AgencyUsersRecord.collection.doc(uid))
              .handleError((_) {}),
    )
